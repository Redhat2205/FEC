...
const CharacteristicsUserRating = ({
  ...
  return (
    <div className="characteristics-container" style={charContainerStyle}>
       ...
       */}
      <input style={charButtonStyle} data-qualid={qualID} type="radio" name={quality} value="1" onChange={handleRadioSelect} />
      <input style={charButtonStyle} data-qualid={qualID} type="radio" name={quality} value="2" onChange={handleRadioSelect} />
      <input style={charButtonStyle} data-qualid={qualID} type="radio" name={quality} value="3" onChange={handleRadioSelect} />
      <input style={charButtonStyle} data-qualid={qualID} type="radio" name={quality} value="4" onChange={handleRadioSelect} />
      <input style={charButtonStyle} data-qualid={qualID} type="radio" name={quality} value="5" onChange={handleRadioSelect} />
    </div>
  );
};
